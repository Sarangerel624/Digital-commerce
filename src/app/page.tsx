...
const Page = () => {
  ...
  const fourProducts = async () => {
    const response = await fetch('https://dummyjson.com/products?limit=4&skip=1')
    if(response.ok) {
  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="text-2xl text-center text-gray-600">Check out our most popular items that customers love.</div>
      </div>
